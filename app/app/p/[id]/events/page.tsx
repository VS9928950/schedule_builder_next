...
export default async function EventsTab({ params }: { params: Promise<{ id: string }> }) {
  ...
  const untimed: UntimedEditableEvent[] = rawEvents
    ...
    .map((e: any, idx: number) => ({
      ...
      announcement: e.announcement ? String(e.announcement) : undefined,
      speakers: e.speakers ? String(e.speakers) : undefined,
      popup: e.popup ? String(e.popup) : undefined,
      popupButtonText: e.popupButtonText ? String(e.popupButtonText) : undefined,
      popupButtonUrl: e.popupButtonUrl ? String(e.popupButtonUrl) : undefined,
