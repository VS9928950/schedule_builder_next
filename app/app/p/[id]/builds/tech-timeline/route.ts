...
import { getProject, updateProjectBuildTechTimelineMarks } from "@/lib/store";
...
export async function POST(req: Request, ctx: { params: Promise<{ id: string }> }) {
  ...
  updateProjectBuildTechTimelineMarks(projectId, user.id, parsed.data.buildId, parsed.data.marks);
