...
import { getProject, updateProjectBuildTechTimelineLayout } from "@/lib/store";
...
export async function POST(req: Request, ctx: { params: Promise<{ id: string }> }) {
  ...
  updateProjectBuildTechTimelineLayout(projectId, user.id, parsed.data.buildId, parsed.data.layout);
