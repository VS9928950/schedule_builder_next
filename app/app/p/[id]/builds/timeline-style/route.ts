...
const Schema = z.object({
  ...
  style: z.object({
    ...
    extraFieldsFontPx: z.number().int().min(9).max(20).optional(),
    extraFieldsColor: z.string().regex(/^#[0-9a-fA-F]{6}$/).optional(),
    extraFieldsWeight: z.number().int().min(100).max(900).optional(),
    extraFieldsItalic: z.boolean().optional(),
